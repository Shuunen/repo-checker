...
test('repo-checker folder succeed with acceptable max size', async function () {
  ...
  equal(passed, [
    ...
    'a-install-step-in-ci-workflow',
    'at-least-one-test-step-in-ci-workflow',
    'has-a-license-file',
    ...
    'main-file-maximum-size-is-specified-in-data-file-ex-max-size-ko-100',
    'has-a-dist-repo-check-min-cjs-file',
    'main-file-specified-in-package-json-dist-repo-check-min-cjs-exists-on-disk-be-sure-to-build-before-run-repo-check',
    'main-file-size-37ko-should-be-less-or-equal-to-max-size-allowed-120ko',
    ...
    'one-unit-testing-dependency-from-mocha-uvu',
    'one-coverage-dependency-from-nyc-c8',
    'assert-dependency-used-in-import-equal-from-uvu-assert-instead-works-also-as-deep-equal-alternative',
