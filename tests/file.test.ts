...
describe('file', () => {
  ...
  it('validator with fix & force, overwrite a problematic file with template', async () => {
  ...
  it('validator with fix & force, update a problematic file on the go', async () => {
    let originalContent = ''
    class MyFileFixForce extends File {
      async start (): Promise<void> {
        await this.inspectFile(existingFilename)
  ...
  it('validator without force cannot fix a problematic file on the go', async () => {
    let originalContent = ''
    class MyFileFixForce extends File {
      async start (): Promise<void> {
        await this.inspectFile(existingFilename)
  ...
  it('validator with fix cannot fix if the template require data that is missing', async () => {
    class MyFileFix extends File {
      async start (): Promise<void> {
