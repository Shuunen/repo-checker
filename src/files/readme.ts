...
export class ReadmeFile extends FileBase {
  ...
  private async getThanks() {
    ...
    list.push(
      ...
      new Thanks('Preact', 'https://preactjs.com', 'fast 3kB alternative to React', this.data.isUsingPreact),
      new Thanks('React', 'https://react.dev', 'great library for web and native user interfaces', this.data.isUsingReact),
